...
write.table(sample_metadata_hmf, file = paste0(wd, "/external-files/biopsy_loc_info_processed.tsv"), sep = "\t", row.names = F, quote = F)
...
biopsy_summary <- ttbiopsy_summary
