...
## Prepring activeDriverWGS input
...
## Reading in the mutation inpput data
...
## Making sure there are not any duplicated rows
...
## Making sure the rows corresponding to chromosome M are excluded
